...
public final class AnymoteReceive {
  ...
  private boolean is318842 = false;
  ...
  public AnymoteReceive(Context context,Handler handler) {
    ...
    is318842 = Utils.checkCurrentSystemIsRK3188_42();
...
//			if(is318842)
				sendMouseMessageToServer3188_42(arg0, arg1);
//			else {
...
//					Log.v("22222", "2222");
				...
				}else if(arg0.getNumber()==KeyEvent.KEYCODE_BUTTON_A){
					sendKeyEventMessageToServer(isLongPress, isCapsOn, KeyEvent.KEYCODE_PAGE_UP);
				}else if(arg0.getNumber()==KeyEvent.KEYCODE_BUTTON_B){
					sendKeyEventMessageToServer(isLongPress, isCapsOn, KeyEvent.KEYCODE_PAGE_DOWN);
				}else if(arg0.getNumber()==KeyEvent.KEYCODE_FORWARD_DEL){
					sendKeyEventMessageToServer(isLongPress, isCapsOn, KeyEvent.KEYCODE_BACK);
				}else if(arg0.getNumber()==KeyEvent.KEYCODE_SWITCH_CHARSET){
					sendKeyEventMessageToServer(isLongPress, isCapsOn, KeyEvent.KEYCODE_MEDIA_PAUSE);
				}
				else {
					sendKeyEventMessageToServer(isLongPress, isCapsOn, arg0.getNumber());
				}
...
//    ackManager.start();
  ...
  public void sendMouseMessageToServer3188_42(int deltaX,int deltaY){
